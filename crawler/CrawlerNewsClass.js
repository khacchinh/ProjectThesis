...
var processreduplicatenew_1 = require("./processreduplicatenew");
...
var CrawlerNewsClass = (function () {
    ...
    CrawlerNewsClass.prototype.getCralweData = function () {
        var p = new Promise(function (resolve, reject) {
            var title = '';
            var count = 0;
            var processReduplicateNew = new processreduplicatenew_1.ProcessReduplicateNew();
            var c = new Crawler({
                maxConnections: 27,
